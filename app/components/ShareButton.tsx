...
export default function ShareButton() {
  ...
  return (
    <>
      ...
      <div className="share-capture-container" ref={captureRef}>
        <div className="share-capture-card">
          <div className="share-capture-header">
            <h2 className="share-capture-title">Resumen Diario</h2>
            <p className="share-capture-date">
              {today.charAt(0).toUpperCase() + today.slice(1)}
            </p>
          </div>

          <div className="share-capture-row">
            <span className="share-capture-stat-label">Total Prestado</span>
            <span className="share-capture-stat-value share-capture-total-lent">
              {stats ? formatMoney(stats.lent) : "..."}
            </span>
          </div>

          <div
            className="share-capture-row"
            style={{
          ...
          >
            ...
            >
              <span className="share-capture-stat-label">Total Cobrado</span>
              <span className="share-capture-stat-value share-capture-collected">
          ...
          <div className="share-capture-row">
            <span className="share-capture-stat-label">Clientes Activos</span>
            <span className="share-capture-stat-value share-capture-clients">
              {stats ? stats.activeClients : "..."}
            </span>
          </div>

          <div className="share-capture-footer">
