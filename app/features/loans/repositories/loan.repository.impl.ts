...
export class LoanRepositoryImpl implements LoanRepository {
  ...
  getLoanReport(
    ...
    return api.safe
      .get<ReportDataDto>(`/report/loan?${params.toString()}`)
