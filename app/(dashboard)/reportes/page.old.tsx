...
export default function ReportesPage() {
  ...
  const loadCollectors = async (companyId?: string) => {
    try {
      ...
      const activeCollectors = allUsers.filter(
        (u) => u.profile === "COBRADOR" && u.status === "ACTIVE",
      );
  ...
  const getMatrixData = () => {
    ...
    const sortedClients = Object.keys(matrix).sort((a, b) =>
      a.localeCompare(b),
    );
  ...
  return (
    <div style={{ maxWidth: "1200px", margin: "0 auto", width: "100%" }}>
      ...
      {reportData && (
        <>
          ...
          >
            <div
              className="card"
              style={{ padding: isMobile ? "0.75rem" : "1.25rem" }}
            >
              <span
                className="label"
                ...
                >
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      >
                        {formatMoney(
                          Object.values(clientTotals).reduce(
                            (a, b) => a + b,
                            0,
                          ),
                        )}
      ...
      {!reportData && !loading && (
        ...
        >
          <div
            style={{ fontSize: "4rem", marginBottom: "1.5rem", opacity: 0.2 }}
          >
            📊
          </div>
          <h3
          ...
          >
            Selecciona un rango de fechas y filtros para analizar el rendimiento
            de tus cobros y egresos.
          </p>
        </div>
      )}
    </div>
